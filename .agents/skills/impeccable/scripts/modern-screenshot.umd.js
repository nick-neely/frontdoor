(function (y, v) {
  ...
  async function ft(e, t = "image/png", r = 1) {
    return await C(this, null, function* () {
      try {
  ...
  const gt = async (e) => await ge(e, "dataUrl"),
    mt = async (e) => await ge(e, "arrayBuffer");
  function _(e, t) {
  ...
  async function L(e, t) {
    return await new Promise((r) => {
      ...
      if ((n && (c = setTimeout(l, n)), Y(o))) {
        ...
        if (!d) {
          o.poster ? L(o.poster, t).then(r) : l();
          return;
        }
        if (o.readyState >= 2) {
          l();
    ...
    return await C(this, null, function* () {
      V(e) &&
        ($(e) || Y(e)
          ...
          : yield Promise.all(
              ["img", "video"].flatMap((r) =>
                [...e.querySelectorAll(r)].map(async (n) => await L(n, t))
              )
            ));
    });
  }
            ...
            workers: Array.from({ length: ze && n && i ? i : 0 })
              .map(() => {
                try {
                  ...
                  return (
                    (b.onmessage = async (w) =>
                      await C(this, null, function* onmessage() {
                        let $e, A, B, F;
  ...
  async function Bt(e) {
    const o = e,
      ...
      s = r
        ...
        : void 0;
    return await fetch(t, D({ signal: a.signal }, i))
      .then(async (c) => {
        if (!c.ok) {
